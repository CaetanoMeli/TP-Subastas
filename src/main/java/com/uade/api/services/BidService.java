...
public class BidService {
    ...
    public void addBid(UserModel userModel, BigDecimal amount, Integer catalogId) {
        ...
        boolean isValidAmount = amount.compareTo(onePercentOfBasePrice) >= 0 && isHigherThanWinningBid && (isGoldOrPlatinum || currentValue == null || twentyPercentOfLastWinningBid != null && winningBid.getAmount().subtract(amount).compareTo(twentyPercentOfLastWinningBid) <= 0);
